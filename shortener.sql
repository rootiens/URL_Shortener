...
INSERT INTO `migrations` VALUES (1,'2020_11_01_091229_create_urls_table',1);
...
CREATE TABLE `urls` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `urls_code_unique` (`code`)
...
--
-- Dumping routines for database 'url_shortener'
--
...
-- Dump completed on 2020-11-02  9:29:21
